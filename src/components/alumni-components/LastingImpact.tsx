      ...
      <div className="max-w-7xl mx-auto bg-gray-100 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 shadow-md">
        ...
        <div className="relative flex-1 w-full max-w-lg">
          <Image
            ...
            width={500}
            height={300}
            className="rounded-xl shadow-lg object-cover w-full h-auto group transition duration-700 transform hover:scale-[1.02]"
          />
          <div className="absolute bottom-4 right-4 bg-emerald-600 text-white rounded-xl px-4 py-3 shadow-md text-sm w-56 group transition duration-700 transform hover:scale-[1.02]">
