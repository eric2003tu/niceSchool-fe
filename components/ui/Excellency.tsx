      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-2 w-full text-[#0a0a40]">
        <div className="w-full grid grid-cols-1 gap-6 h-fit mt-18">
            ...
            <div className="flex flex-row gap-3">
                <button className="text-white text-xl font-bold text-center bg-[#0F9255] p-2 px-4 rounded-md cursor-pointergroup transition duration-300 transform hover:scale-[1.02] hover:shadow-xl ">Learn More</button>
                <button className="border-[#0a0a40] border text-xl font-bold text-center p-2 px-4 rounded-md cursor-pointer group transition duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:border-[#0F9255] hover hover:text-[#0F9255]">Vitual Tour</button>
            </div>
        </div>
    ...
    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-3 w-full text-white mt-7 text-xl">
      {ap.map((item, index) => (
        <div
          ...
          className="grid grid-cols-1 w-full bg-cover bg-no-repeat h-64 rounded-md justify-items-bottom group transition duration-300 transform hover:scale-[1.02]"
        >
